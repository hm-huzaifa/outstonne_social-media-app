...
const Pin = ({ pin: { postedBy, image, _id, destination, save } }) => {
  ...
  // 4, [2, 3, 1] -> [0].length -> !0 -> true -> !true -> false
            ...
            <div className="flex items-center justify-between">
              <div className="flex gap-2">
                <a
                  ...
                  className="bg-white w-9 h-9 p-2 mt-2 rounded-full flex items-center justify-center text-dark text-xl opacity-75 hover:opacity-100 hover:shadow-md outline-none"
                >
            ...
            <div className="flex justify-between items-center gap-2 w-full">
              {destination && (
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="bg-white flex items-center gap-2 h-6 text-black font-medium p-2 pl-4 pr-4 rounded-full opacity-70 hover:opacity-100 hover:shadow-md"
                >
